...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_invalid_boolean(self):
        """It should raise a DataValidationError for invalid boolean"""
        data = {
            "name": "Test Product",
            "description": "A product for testing",
            "price": "19.99",
    ...
    def test_deserialize_missing_attribute(self):
        """It should raise a DataValidationError for missing attribute"""
        data = {
            "description": "A product for testing",
            "price": "19.99",
            "available": True,
    ...
    def test_deserialize_no_data(self):
        """It should raise a DataValidationError for no data"""
        product = Product()
        with self.assertRaises(DataValidationError) as context:
    ...
    def test_find_by_price(self):
        ...
        ProductFactory(price=Decimal('20.00')).create()
        ProductFactory(price=Decimal('10.00')).create()

        # Test finding by price as Decimal
        found_products = Product.find_by_price(Decimal('10.00'))
        ...
        # Test finding by price as string with spaces
